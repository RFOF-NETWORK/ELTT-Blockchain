"""
PYTHON-ELTT-MODULE-PARITY/ELTT-launcher/ELTT-Viewer.py

Viewer-Sicht aus dem Modul: ELTT-launcher
...
class ViewerSnapshot:
    ...
    aus Sicht des ELTT-launcher-Moduls.
    """
...
def build_viewer_snapshot(
    ...
    """
    Erzeugt einen vollständigen, reinen Lese-Snapshot für das ELTT-launcher-Modul.
