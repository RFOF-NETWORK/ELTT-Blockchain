"""
PYTHON-ELTT-MODULE-PARITY/ELTT-liquidity-pools/ELTT-Viewer.py

Viewer-Sicht aus dem Modul: ELTT-liquidity-pools
...
class ViewerSnapshot:
    ...
    aus Sicht des ELTT-liquidity-pools-Moduls.
    """
...
def build_viewer_snapshot(
    ...
    """
    Erzeugt einen vollständigen, reinen Lese-Snapshot für das
    ELTT-liquidity-pools-Modul.
    """
