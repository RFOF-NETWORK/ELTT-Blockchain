"""
PYTHON-ELTT-MODULE-PARITY/ELTT-Blockchain/ELTT-Viewer.py

Viewer-Sicht aus dem Modul: ELTT-Blockchain
...
class ViewerSnapshot:
    ...
    aus Sicht des ELTT-Blockchain-Moduls.
    """
...
def build_viewer_snapshot(
    ...
    """
    Erzeugt einen vollständigen, reinen Lese-Snapshot für das ELTT-Blockchain-Modul.
